...
data visualizations an everyday phenomenon (see \citealp{bbc_2022}, for examples of the types of visualizations many saw daily). As data visualization designers, we have a duty to design in such a way that viewers with little to no formal statistical
...
@micallef_2017 test an automated system for varying scatterplot aspect ratio, point size, 
...
although this was carried out uniformly to do deal with overplotting issues. In addition to studies
...
standard deviations of 1 in each direction. All plots presented
...
**lme4** (version 1.1-30 [@bates_lme4_2015]) packages, with contrast condition
...
and **lme4** (version 1.1-30 [@bates_lme4_2015]) packages, with contrast decay function
being set as the predictor for participants' error in correlation estimates.
...
patterns when *r* is close to one (scatterplot tends towards a single line of points)
...
Perhaps the most interesting avenue for future work is the possibility of combining
