...
\citealp{micallef_2017} test an automated system for varying scatterplot aspect ratio, point size, 
...
Models were built using the **buildmer** (version 2.7 \citealp{voeten_buildmer_2022}) and
**lme4** (version 1.1-30 \citealp{bates_lme4_2015}) packages, with contrast condition
...
was performed with the **emmeans** package (version 1.8.1-1, \citealp{emmeans}) and are 
