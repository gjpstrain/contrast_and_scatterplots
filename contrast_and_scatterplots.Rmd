...
the computational environment this paper was written in, allowing for a full replications
...
```{r changes-with-r-e1, warning=FALSE, echo=FALSE, message=FALSE, fig.align='default',fig.show='hold', out.width="100%", fig.cap="\\label{e1-changes-plot}Plots showing how participants' mean correlation estimation errors change with Pearson's \\textit{r} in experiment 1. Participants were on average most accurate at estimating the \\textit{r} value when presented with the full contrast scatterplots (condition D). Error bars show standard deviations of estimates.", description ="Series of four plots showing how participants' mean correlation estimates vary as a function of the actual r value, over the four conditions in experiment 1. Error bars show standard deviations for mean estimates over the 45 r values.", crop = TRUE}
...
differences in the contrasts of points *can* affect correlation estimates in scatterplots.
...
contrast condition from the first experiment. We used the equation 1 to non-linearly
