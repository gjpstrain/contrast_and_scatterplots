...
All analyses were conducted using R (version 4.2.0, [@r_core]).

Models were built using the **buildmer** (version 2.4 [@voeten_buildmer_2022]) and
...
was performed with the **emmeans** package (version 1.7.3, [@emmeans]) and are 
...
As in E1, models were built using the **buildmer** (version 2.4, [@voeten_buildmer_2022])
...
conditions was performed with the **emmeans** package (version 1.7.3, [@emmeans])
