...
this would necessitate hiding data, thus changing the information presented to the viewer. An alternative approach is to manipulate 
...
optimise perception of correlation in scatterplots, however there remains much to do.
...
Given, however, given previous work [@sher_2017] which found evidence for people overestimating
