...
data visualizations an everyday phenomenon (see @bbc_2022 for examples of the types of visualizations many saw daily). As data visualizations designers, we have a duty to design in such a way that viewers with little to no formal statistical
...
\ref{underestimation-curve} for an approximation of the underestimation observed. In addition to studies
...
Ad-hoc piloting with a graduate student 
...
In addition, participants who had completed an earlier, similar study were prevented from participating.
