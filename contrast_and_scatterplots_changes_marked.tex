...
%DIF DEL C:\Users\mbch4gs2\AppData\Local\Temp\tmp_old_ca3l0rf_.tex   Fri Feb 24 09:54:20 2023
%DIF ADD C:\Users\mbch4gs2\AppData\Local\Temp\tmp_new_ba5_ymj5.tex   Fri Feb 24 09:54:20 2023
...
Scatterplots}
  ...
  %
   ...
   \ead{Andrew.J.Stewart@manchester.ac.uk} 
    \DIFdelbegin %DIFDELCMD < \author[SSS]{%%%
\DIFdelend \DIFaddbegin \author[DOP]{\DIFaddend Paul Warren%
  %
  }
  ...
  %
   ...
   \ead{Caroline.Jay@manchester.ac.uk} 
      \DIFdelbegin %DIFDELCMD < \affiliation[CS]{organization = {Department of Computer Science, Faculty of Science and Engineering},
%DIFDELCMD < 			addressline = { University of Manchester, Oxford Road},
%DIFDELCMD < 			city = {Manchester},
%DIFDELCMD < 			postcode = {M13 9PL},
%DIFDELCMD < 			country = {United Kingdom.}}
%DIFDELCMD <     \affiliation[SSS]{organization = {Division of Psychology, Communication, and Human Neuroscience, School of Health Sciences, Faculty of Biology, Medicine, and Health},
%DIFDELCMD < 			addressline = {University of Manchester, Oxford Road},
%DIFDELCMD < 			city =  {Manchester},
%DIFDELCMD < 			postcode = {M13 9PL},
%DIFDELCMD < 			country = {United Kingdom.}}
%DIFDELCMD <     %%%
\DIFdelend \DIFaddbegin \affiliation[CS]{organization={Department of Computer Science, Faculty of Science and Engineering},
...
postcode={M13 9PL},
country={United Kingdom}}
    \DIFaddend \cortext[cor1]{Corresponding author}

  \begin{abstract}
  Scatterplots are common data visualizations that can be used to
  communicate a range of ideas, \DIFdelbegin \DIFdel{primarily the }\DIFdelend \DIFaddbegin \DIFadd{the most intensively studied being the
  }\DIFaddend correlation between two variables. Despite their ubiquity, people
...
This \DIFdelbegin \DIFdel{paper is approximately 7654 }\DIFdelend \DIFaddbegin \DIFadd{submission is approximately 7700 }\DIFaddend words.
...
communicate ideas [\ldiffentity{\textit{Azzam et~al.}, \ldiffentity{2013}}]. Where once they were the preserve
...
increasingly common [\ldiffentity{\textit{Friendly and Denis}, \ldiffentity{2005}}; \ldiffentity{\textit{Azzam et~al.}, \ldiffentity{2013}}]. The speed of the
...
everyday phenomenon (see \DIFdelbegin \DIFdel{\ldiffentity{\textit{BBC} [\ldiffentity{2022}]} }\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citealp{bbc_2022}}\hskip0pt%DIFAUXCMD
, }\DIFaddend for examples of the types
...
significantly increases the accuracy of people's performance on \DIFdelbegin \DIFdel{correlation estimation tasks}\DIFdelend \DIFaddbegin \DIFadd{a
correlation estimation task}\DIFaddend . In our first experiment, we show that
...
of data visualizations in scientific publications [\ldiffentity{\textit{Tufte and Graves-Morris}, \ldiffentity{1983}}],
are simple representations of bivariate data that people generally
interpret in the same way [\ldiffentity{\textit{Kay and Heer}, \ldiffentity{2015}}]. \ldiffentity{\textit{Rensink} [\ldiffentity{2014}]}
...
visualization design and perception. \DIFaddbegin \DIFadd{Designers of data visualizations
...
\DIFdelbegin %DIFDELCMD < \hypertarget{testing-correlation-perception}{%
%DIFDELCMD < \subsection{Testing Correlation
%DIFDELCMD < Perception}\label{testing-correlation-perception}}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \hypertarget{testing}{%
\subsection{Testing Correlation Perception}\label{testing}}
\DIFaddend 

The \DIFdelbegin \DIFdel{primary concept communicated by }\DIFdelend \DIFaddbegin \DIFadd{most intensively studied aspect of }\DIFaddend scatterplots is correlation
\DIFaddbegin \DIFadd{perception}\DIFaddend , (i.e the strength of the relationship between two
variables)\DIFaddbegin \DIFadd{, although they are used for a wide variety of other tasks,
including cluster separation, outlier detection, and trend
identification }[\DIFadd{\ldiffentity{\textit{Behrisch et~al.}, \ldiffentity{2018}}}]\DIFaddend . Throughout this paper we refer to
...
paradigms. Very early work [\ldiffentity{\textit{Pollack}, \ldiffentity{1960}}] asked participants to
...
[\ldiffentity{\textit{Strahan and Hansen}, \ldiffentity{1978}}; \ldiffentity{\textit{Bobko and Karren}, \ldiffentity{1979}}; \ldiffentity{\textit{Cleveland et~al.}, \ldiffentity{1982}}; \ldiffentity{\textit{Lane et~al.}, \ldiffentity{1985}}; \ldiffentity{\textit{Lauer and Post}, \ldiffentity{1989}}; \ldiffentity{\textit{Collyer et~al.}, \ldiffentity{1990}}; \ldiffentity{\textit{Meyer and Shinar}, \ldiffentity{1992}}],
see Figure \ref{underestimation-curve} for an approximation of the
underestimation observed. \DIFaddbegin \DIFadd{\ldiffentity{\textit{Micallef et~al.} [\ldiffentity{2017}]} test an automated system
...
overplotting issues. }\DIFaddend In addition to studies employing discriminative
...
[\ldiffentity{\textit{Rensink and Baldridge}, \ldiffentity{2010}}] \DIFdelbegin \DIFdel{allows }\DIFdelend \DIFaddbegin \DIFadd{allowed }\DIFaddend researchers to obtain measurements for
...
\includegraphics{underestimation-curve-1} \hfill{}
...
\DIFdel{\ldiffentity{\textit{Cleveland et~al.}, \ldiffentity{1982}}}%DIFDELCMD < ] %%%
\DIFdelend \DIFaddbegin \DIFadd{, \mbox{%DIFAUXCMD
\citealp{cleveland_1982}}\hskip0pt%DIFAUXCMD
...
\DIFdel{\ldiffentity{\textit{Meyer et~al.}, \ldiffentity{1997}}}%DIFDELCMD < ]%%%
\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citealp{meyer_1997}}\hskip0pt%DIFAUXCMD
)}\DIFaddend .
...
\DIFdelbegin %DIFDELCMD < \hypertarget{contrast}{%
%DIFDELCMD < \subsection{Contrast}\label{contrast}}
%DIFDELCMD < %%%
...
solve problems of overplotting \DIFaddbegin \DIFadd{or clutter
}\DIFaddend [\ldiffentity{\textit{Matejka et~al.}, \ldiffentity{2015}}; \ldiffentity{\textit{Bertini and Santucci}, \ldiffentity{2004}}], in which scatterplots with very
...
\DIFaddbegin \DIFadd{Reducing the contrast of all points in such a way increases their levels
...
visual perception }[\DIFadd{\ldiffentity{\textit{Ginsburg}, \ldiffentity{2003}}}] \DIFadd{we elected to use the term
...
\DIFaddend Despite the popularity of \DIFdelbegin \DIFdel{this
technique}\DIFdelend \DIFaddbegin \DIFadd{adjusting contrast to address overplotting
issues}\DIFaddend , little investigation has taken place into the effects of
...
changes in point contrast [\ldiffentity{\textit{Rensink}, \ldiffentity{2012}}], although this work took
...
We use the \textbf{ggplot2} [\ldiffentity{\textit{Wickham}, \ldiffentity{2016}}] package for plot
creation in both experiments, which uses an alpha parameter to set
contrast. Alpha here refers to the linear interpolation
[\ldiffentity{\textit{Stone}, \ldiffentity{2008}}] between foreground and background pixel values; alpha
...
[\ldiffentity{\textit{Zuffi et~al.}, \ldiffentity{2007}}] based on what is being presented, for example models
...
perception \DIFaddbegin \DIFadd{averaged over a series of 180 single-plot presentation
trials}\DIFaddend , we do not consider this a shortcoming. In light of this however,
...
\includegraphics[width=0.5\linewidth]{formal-contrast-1} \hfill{}
...
experiments were built using PsychoPy [\ldiffentity{\textit{Peirce et~al.}, \ldiffentity{2019}}], and
...
laptop. As with the luminances of scatterplots and their points, \DIFdelbegin \DIFdel{we had
...
experiments, we }\DIFdelend \DIFaddbegin \DIFadd{our
crowd-sourced approach renders the measurement of participant-to-monitor
distance and the recording of exact apparatus impossible. We }\DIFaddend do not
consider this \DIFdelbegin \DIFdel{to be an issue}\DIFdelend \DIFaddbegin \DIFadd{a shortcoming however, as it allows for findings that are
robust to various displays and viewing contexts and allows us to make
conclusions that are of particular relevance to the HCI audience}\DIFaddend .
...
Subjective Graph Literacy (SGL) test [\ldiffentity{\textit{Garcia-Retamero et~al.}, \ldiffentity{2016}}]. Participants
...
0.8, and 0.95, which can be see in Figure \ref{example-plots}. \DIFaddbegin \DIFadd{See
Section \ref{training} for a discussion of the potential effects of
this. }\DIFaddend Participants were then given two practice trials before the
experiment began.

\begin{figure}

\includegraphics[width=0.5\linewidth]{example-plots} \hfill{}
...
correlation displayed and set the slider to 1\DIFdelbegin \DIFdel{/0}\DIFdelend ''\footnote{The word
  ...
  items.} (\DIFaddbegin \DIFadd{n = 3) or ``Please IGNORE the correlation displayed and set
the slider to 0'' (n = 3) (}\DIFaddend in red, attention check trial\DIFdelbegin \DIFdel{, n = 6}\DIFdelend ). Each plot was
...
\includegraphics[width=0.5\linewidth]{example-trial} \hfill{}
...
distributions\DIFaddbegin \DIFadd{, having a standard deviations of 1 in each direction}\DIFaddend . All
plots presented were 1200 * 1200 pixels in size, and included no titles,
tick labels, or axis labels. \DIFaddbegin \DIFadd{Points were 10 pixels in diameter on a
...
future work. }\DIFaddend Each plot contained 128 data points. 45 \emph{r} values
...
perceived below 0.2 [\ldiffentity{\textit{Bobko and Karren}, \ldiffentity{1979}}; \ldiffentity{\textit{Cleveland et~al.}, \ldiffentity{1982}}; \ldiffentity{\textit{Strahan and Hansen}, \ldiffentity{1978}}].
...
there were no deviations from them. \DIFdelbegin \DIFdel{Consistent with our pre-registrations, when producing models for our analyses}\DIFdelend \DIFaddbegin \DIFadd{We used linear mixed-effects models
...
modelling. Consistent with our pre-registrations}\DIFaddend , we aimed for the most
complex random effects structures \DIFaddbegin \DIFadd{when producing models}\DIFaddend . The structure
of these models was identified using the \textbf{buildmer} package in R
[\ldiffentity{\textit{Voeten}, \ldiffentity{2023}}]. This package takes the most complex random
effects model\DIFdelbegin \DIFdel{and subsequently removes random effects terms that do not
substantially contribute to explaining variancein correlation ratings. This }\DIFdelend \DIFaddbegin \DIFadd{, in terms of intercepts for participants and items and
...
}\DIFaddend approach does mean that the final model used is not always the most
complex one possible, but rather is the most complex that substantially
explains variance and converges.

\DIFaddbegin \hypertarget{normality}{%
\section{Normality}\label{normality}}

\begin{figure}

\includegraphics[width=0.5\linewidth]{normality-plots-1} \includegraphics[width=0.5\linewidth]{normality-plots-2} \hfill{}

\caption{\label{normality-plots}\DIFaddFL{qqplots showing the distribution of errors in experiments 1 and 2.}}\label{fig:normality-plots}
\end{figure}

\DIFadd{Figure \ref{normality-plots} shows qqplots testing the normality of
...
}[\DIFadd{\ldiffentity{\textit{Ghasemi and Zahediasl}, \ldiffentity{2012}}}]\DIFadd{, so no transform was used.
}

\DIFaddend \hypertarget{experiment-1-changing-the-contrast-of-all-points}{%
...
described above [\ldiffentity{\textit{Champion and Warren}, \ldiffentity{2017}}; \ldiffentity{\textit{Wehrhahn and Westheimer}, \ldiffentity{1990}}], we hypothesized
...
current paper, }\DIFaddend were prevented from participating.
...
graph literacy score was 21.76 (\emph{SD} = 4.47) out of 30. \DIFaddbegin \DIFadd{The average
...
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=1\linewidth]{plot_examples/uniform_adjustments_plot_examples} %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.5\linewidth]{e1-example-plots-1} \includegraphics[width=0.5\linewidth]{e1-example-plots-2} \includegraphics[width=0.5\linewidth]{e1-example-plots-3} \includegraphics[width=0.5\linewidth]{e1-example-plots-4} \DIFaddendFL \hfill{}
...
All analyses were conducted using R (version 4.2\DIFdelbegin \DIFdel{.1, }%DIFDELCMD < [%%%
\DIFdel{\ldiffentity{\textit{Team}, \ldiffentity{2022}}}%DIFDELCMD < ]%%%
\DIFdelend \DIFaddbegin \DIFadd{.2, \mbox{%DIFAUXCMD
\citealp{r_core}}\hskip0pt%DIFAUXCMD
}\DIFaddend ).
Models were built using the \textbf{buildmer} (version \DIFdelbegin \DIFdel{2.7
}%DIFDELCMD < [%%%
\DIFdel{\ldiffentity{\textit{Voeten}, \ldiffentity{2023}}}%DIFDELCMD < ]%%%
\DIFdelend \DIFaddbegin \DIFadd{2.8,
\mbox{%DIFAUXCMD
\citealp{voeten_buildmer_2022}}\hskip0pt%DIFAUXCMD
}\DIFaddend ) and \textbf{lme4} (version 1.1\DIFdelbegin \DIFdel{-30
}%DIFDELCMD < [%%%
\DIFdel{\ldiffentity{\textit{Bates et~al.}, \ldiffentity{2015}}}%DIFDELCMD < ]%%%
\DIFdel{) packages}\DIFdelend \DIFaddbegin \DIFadd{-31,
\mbox{%DIFAUXCMD
\citealp{bates_lme4_2015}}\hskip0pt%DIFAUXCMD
) packages, with contrast condition being set
as the predictor for participants' error in correlation estimates}\DIFaddend .
\DIFdelbegin \textbf{\DIFdel{buildmer}} %DIFAUXCMD
\DIFdel{takes the most
...
\DIFdel{\ldiffentity{\textit{Barr et~al.}, \ldiffentity{2013}}}%DIFDELCMD < ] %%%
\DIFdel{as an input. It then identifies the most
...
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=0.5\linewidth]{e1-bar-plot-1} %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.5\linewidth]{e1-dot-plot-1} \DIFaddendFL \hfill{}

\caption{\DIFdelbeginFL %DIFDELCMD < \label{e1-bar-plot}%%%
\DIFdelendFL \DIFaddbeginFL \label{e1-dot-plot}\DIFaddendFL Mean error in correlation estimation across the four contrast conditions in E1\DIFaddbeginFL \DIFaddFL{, with 95\% confidence intervals shown}\DIFaddendFL .}\DIFdelbeginFL %DIFDELCMD < \label{fig:e1-bar-plot}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \label{fig:e1-dot-plot}
\DIFaddendFL \end{figure}

Figure \DIFdelbegin \DIFdel{\ref{e1-bar-plot} }\DIFdelend \DIFaddbegin \DIFadd{\ref{e1-dot-plot} }\DIFaddend shows the mean error in correlation estimation
for the 4 contrast conditions. A likelihood ratio test \DIFdelbegin \DIFdel{reveals }\DIFdelend \DIFaddbegin \DIFadd{revealed }\DIFaddend that the
...
1.8\DIFdelbegin \DIFdel{.1}\DIFdelend \DIFaddbegin \DIFadd{.4}\DIFaddend -1, \DIFdelbegin %DIFDELCMD < [%%%
\DIFdel{\ldiffentity{\textit{Lenth}, \ldiffentity{2023}}}%DIFDELCMD < ]%%%
\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citealp{emmeans}}\hskip0pt%DIFAUXCMD
}\DIFaddend ) and are shown in table
\ref{contrasts-table-e1}. Means and \DIFdelbegin \DIFdel{standard deviations }\DIFdelend \DIFaddbegin \DIFadd{95\% confidence intervals }\DIFaddend of
correlation judgements are shown in \DIFdelbegin \DIFdel{table \ref{sum-stats-e1}. }\DIFdelend \DIFaddbegin \DIFadd{Figure \ref{e1-dot-plot}. The
}\textbf{\DIFadd{EMAtools}} \DIFadd{package (version 0.1.4, \mbox{%DIFAUXCMD
\citealp{ematools}}\hskip0pt%DIFAUXCMD
) was used
...
perception of global point contrast adjustments }[\DIFadd{\ldiffentity{\textit{Rensink}, \ldiffentity{2012}}}] \DIFadd{is
...
%DIFDELCMD < \caption{%
{%DIFAUXCMD
%DIFDELCMD < \label{tab:sum-stats-e1}\label{sum-stats-e1}%%%
\DIFdelFL{This table shows means and standard errors for the contrast conditions in E1. A = Low contrast (alpha = 0.25), Medium contrast (alpha = 0.5), C = High contrast (alpha = 0.75), D = Full contrast (alpha = 1).}}
%DIFAUXCMD
%DIFDELCMD < \centering
%DIFDELCMD < \begin{tabular}[t]{lrr}
%DIFDELCMD < \toprule
%DIFDELCMD < %%%
\DIFdelFL{Contrast }%DIFDELCMD < & %%%
...
\DIFdelFL{0.152 }%DIFDELCMD < & %%%
\DIFdelFL{0.202}%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdelFL{B }%DIFDELCMD < & %%%
\DIFdelFL{0.166 }%DIFDELCMD < & %%%
\DIFdelFL{0.201}%DIFDELCMD < \\
...
%DIFDELCMD < %%%
\DIFdelend We also generate an additional model to test whether the results we
...
{\centering \includegraphics{e1-error-plot-1} 

}

\caption{\label{e1-error-plot}\DIFaddFL{The mean of participants' estimations of }\textit{\DIFaddFL{r}} \DIFaddFL{compared with objective Pearson's }\textit{\DIFaddFL{r}}\DIFaddFL{, plotted by contrast condition. Error bars show standard deviations of mean estimates.}}\label{fig:e1-error-plot}
\end{figure}

\DIFadd{Figure \ref{e1-error-plot} shows how participants' mean estimates of
correlation change with the objective Pearson's }\emph{\DIFadd{r}} \DIFadd{value, plotted
...
\includegraphics[width=0.5\linewidth]{e1-sd-sd-plot-1} \hfill{}

\caption{\label{e1-sd-sd-plot}\DIFaddFL{The mean of standard deviations of participants in experiment 1, grouped by contrast condition. Error bars show spreads of standard deviations.}}\label{fig:e1-sd-sd-plot}
\end{figure}

\DIFaddend Our hypothesis was not supported in this experiment. We hypothesized
that plots with lower contrast would have a \DIFdelbegin \DIFdel{more variable }\DIFdelend \DIFaddbegin \DIFadd{wider }\DIFaddend spread of correlation
estimates than plots with higher contrast. As shown in \DIFdelbegin \DIFdel{table
\ref{sum-stats-e1}}\DIFdelend \DIFaddbegin \DIFadd{Figure
\ref{e1-sd-sd-plot}}\DIFaddend , there was little difference in \DIFaddbegin \DIFadd{mean }\DIFaddend standard
...
\DIFaddbegin \DIFadd{contrast }\DIFaddend alpha = 0.75 past which there is little variation in the
...
[\ldiffentity{\textit{Varshney and Sun}, \ldiffentity{2013}}; \ldiffentity{\textit{Fechner}, \ldiffentity{1948}}]; despite there being equal linear
distance between the contrast values we used, the perceptual distance
between them was clearly non-linear.

As mentioned previously, \ldiffentity{\textit{Rensink} [\ldiffentity{2012}]} and \ldiffentity{\textit{Rensink} [\ldiffentity{2014}]}
describe what is, to our knowledge, the only other direct testing of
correlation perception and point contrast, and reports \DIFdelbegin \DIFdel{invariance in
accuracy and precision }\DIFdelend \DIFaddbegin \DIFadd{no difference in
either bias or variability in correlation perception }\DIFaddend with regards to
contrast \DIFaddbegin \DIFadd{manipulations}\DIFaddend . Our results\DIFdelbegin \DIFdel{contradict
}\DIFdelend \DIFaddbegin \DIFadd{, in comparison to }\DIFaddend these previously
reported findings, \DIFaddbegin \DIFadd{do find an effect, }\DIFaddend which we argue is due to
\DIFdelbegin \DIFdel{crucial
}\DIFdelend differences in methodology and experimental power. Rensink used
...
\DIFdelbegin \DIFdel{the absolute }\DIFdelend \DIFaddbegin \DIFadd{investigating the mathematical }\DIFaddend relationship between correlation and
perceived correlation \DIFdelbegin \DIFdel{illuminated upon }\DIFdelend \DIFaddbegin \DIFadd{allowed }\DIFaddend by other methodologies. The major strength
of this study is the large sample size (n = 150). Compared with the
relatively small sample size in \ldiffentity{\textit{Rensink} [\ldiffentity{2014}]} (n = 12), our
study's heightened experimental power \DIFdelbegin \DIFdel{represents }\DIFdelend \DIFaddbegin \DIFadd{allows us to present }\DIFaddend strong
evidence that total contrast in a scatterplot can affect people's
perceptions of correlation. \DIFaddbegin \DIFadd{Our effect size for the uniform contrast
...
differences in the contrasts of points }\emph{\DIFadd{can}} \DIFadd{effect correlation
...
functions similarly to speed perception }[\DIFadd{\ldiffentity{\textit{Champion and Warren}, \ldiffentity{2017}}}] \DIFadd{with
...
graph literacy score was 21.71 (\emph{SD} = 4.06) out of 30. \DIFaddbegin \DIFadd{The average
...
value of \(b\)\DIFdelbegin \DIFdel{, which represented an ideal balance between point legibility and contrast decay severity}\DIFdelend \DIFaddbegin \DIFadd{. Given the shape of the underestimation curve reported in
...
range in contrast that, if an effect was present, one would be found}\DIFaddend .
...
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=1\linewidth]{plot_examples/spatially_dependent_plot_examples} %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.5\linewidth]{e2-example-plots-1} \includegraphics[width=0.5\linewidth]{e2-example-plots-2} \includegraphics[width=0.5\linewidth]{e2-example-plots-3} \includegraphics[width=0.5\linewidth]{e2-example-plots-4} \DIFaddendFL \hfill{}
...
\begin{figure}
\includegraphics[width=1\linewidth]{decay-parameters-1} \caption{\label{decay-parameters}Here we use an \textit{r} value of 0.2 to demonstrate the relationship between the size of a point's residual and the contrast alpha value that translates to.}\label{fig:decay-parameters}
\end{figure}
...
in E1, models were built using the \textbf{buildmer} (version \DIFdelbegin \DIFdel{2.7,
}%DIFDELCMD < [%%%
\DIFdel{\ldiffentity{\textit{Voeten}, \ldiffentity{2023}}}%DIFDELCMD < ]%%%
\DIFdelend \DIFaddbegin \DIFadd{2.8,
\mbox{%DIFAUXCMD
...
\mbox{%DIFAUXCMD
\citealp{bates_lme4_2015}}\hskip0pt%DIFAUXCMD
) packages, with contrast decay function being
set as the predictor for participants' error in correlation estimates}\DIFaddend .

\begin{figure}

\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=0.5\linewidth]{e2-bar-plot-1} %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.5\linewidth]{e2-dot-plot-1} \DIFaddendFL \hfill{}

\caption{\DIFdelbeginFL %DIFDELCMD < \label{e2-bar-plot}%%%
\DIFdelendFL \DIFaddbeginFL \label{e2-dot-plot}\DIFaddendFL Mean error in correlation estimation across the four contrast conditions in E2\DIFdelbeginFL \DIFdelFL{.}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{, with 95\% confidence intervals shown}\DIFaddendFL }\DIFdelbeginFL %DIFDELCMD < \label{fig:e2-bar-plot}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \label{fig:e2-dot-plot}
\DIFaddendFL \end{figure}

Figure \DIFdelbegin \DIFdel{\ref{e2-bar-plot} }\DIFdelend \DIFaddbegin \DIFadd{\ref{e2-dot-plot} }\DIFaddend shows mean correlation estimation errors for
...
decay and full contrast conditions. \DIFaddbegin \DIFadd{Similar to the lack of significant
...
(version 1.8\DIFdelbegin \DIFdel{.1}\DIFdelend \DIFaddbegin \DIFadd{.4}\DIFaddend -1, \DIFdelbegin %DIFDELCMD < [%%%
\DIFdel{\ldiffentity{\textit{Lenth}, \ldiffentity{2023}}}%DIFDELCMD < ]%%%
\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citealp{emmeans}}\hskip0pt%DIFAUXCMD
}\DIFaddend ) and are shown in \DIFdelbegin \DIFdel{table
}\DIFdelend \DIFaddbegin \DIFadd{Table
}\DIFaddend \ref{contrasts-table-e2}. Means and \DIFdelbegin \DIFdel{standard deviations }\DIFdelend \DIFaddbegin \DIFadd{95\% confidence intervals }\DIFaddend of
correlation estimates are shown in \DIFdelbegin \DIFdel{table \ref{sum-stats-e2}.}\DIFdelend \DIFaddbegin \DIFadd{Figure \ref{e2-dot-plot}.The
}\textbf{\DIFadd{EMAtools}} \DIFadd{package (version 0.1.4, \mbox{%DIFAUXCMD
\citealp{ematools}}\hskip0pt%DIFAUXCMD
) was used
to calculate effect sizes in Cohen's d.~For the difference in
...
\caption{\label{tab:contrasts-table-e2}\label{contrasts-table-e2}\DIFdelbeginFL \DIFdelFL{This table shows }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Table showing }\DIFaddendFL the contrasts between different levels of the contrast \DIFaddbeginFL \DIFaddFL{condition }\DIFaddendFL factor.\DIFdelbeginFL \DIFdelFL{A = Non-linear contrast decay (a = 0.25). B = Linear decay, C = Non-linear inverted decay, D = Full contrast.}\DIFdelendFL }
\centering
\begin{tabular}[t]{lrl}
\toprule
Contrast & Z.ratio & p.value\\
\midrule
\DIFdelbeginFL \DIFdelFL{D - C }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Full contrast : Non-linear inverted decay }\DIFaddendFL & -18.88 & <0.001\\
\DIFdelbeginFL \DIFdelFL{D - B }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Full contrast : Linear decay }\DIFaddendFL & 1.55 & 0.405\\
\DIFdelbeginFL \DIFdelFL{D - A }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Full contrast : Non-linear contrast decay }\DIFaddendFL & 15.30 & <0.001\\
\DIFdelbeginFL \DIFdelFL{C - B }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Non-linear inverted decay : Linear decay }\DIFaddendFL & 20.43 & <0.001\\
\DIFdelbeginFL \DIFdelFL{C - A }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Non-linear inverted decay : Non-linear contrast decay }\DIFaddendFL & 34.17 & <0.001\\
\addlinespace
\DIFdelbeginFL \DIFdelFL{B - A }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Linear decay : Non-linear contrast decay }\DIFaddendFL & 13.74 & <0.001\\
\bottomrule
\end{tabular}
\end{table}
...
%DIFDELCMD < \caption{%
{%DIFAUXCMD
%DIFDELCMD < \label{tab:sum-stats-e2}\label{sum-stats-e2}%%%
\DIFdelFL{This table shows means and standard errors for the contrast conditions in E2. A = Non-linear contrast decay (a = 0.25). B = Linear decay, C = Non-linear inverted decay, D = Full contrast.}}
%DIFAUXCMD
%DIFDELCMD < \centering
%DIFDELCMD < \begin{tabular}[t]{lrr}
%DIFDELCMD < \toprule
...
%DIFDELCMD < %%%
\DIFdelFL{D }%DIFDELCMD < & %%%
\DIFdelFL{0.123 }%DIFDELCMD < & %%%
\DIFdelFL{0.185}%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdelFL{C }%DIFDELCMD < & %%%
...
%DIFDELCMD < %%%
\DIFdelFL{B }%DIFDELCMD < & %%%
\DIFdelFL{0.119 }%DIFDELCMD < & %%%
\DIFdelFL{0.173}%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdelFL{A }%DIFDELCMD < & %%%
\DIFdelFL{0.086 }%DIFDELCMD < & %%%
\DIFdelFL{0.170}%DIFDELCMD < \\
%DIFDELCMD < \bottomrule
%DIFDELCMD < \end{tabular}
%DIFDELCMD < \end{table}
%DIFDELCMD < 
...
%DIFDELCMD < %%%
\DIFdelend Again, we also generated an additional model to test whether the results
...
{\centering \includegraphics{e2-error-plot-1} 

}

\caption{\label{e2-error-plot}\DIFaddFL{The mean of participants' estimations of }\textit{\DIFaddFL{r}} \DIFaddFL{compared with objective Pearson's }\textit{\DIFaddFL{r}}\DIFaddFL{, plotted by contrast condition}}\label{fig:e2-error-plot}
\end{figure}

\DIFadd{Figure \ref{e2-error-plot} shows how participants' mean estimates of
correlation change with the objective Pearson's }\emph{\DIFadd{r}} \DIFadd{value, plotted
...
\DIFaddend \hypertarget{discussion-1}{%
\subsection{Discussion}\label{discussion-1}}

\DIFaddbegin \begin{figure}

\includegraphics[width=0.5\linewidth]{e2-sd-sd-plot-1} \hfill{}

\caption{\label{e2-sd-sd-plot}\DIFaddFL{The mean of standard deviations of participants in experiment 2, grouped by contrast condition. Error bars show spreads of standard deviations}}\label{fig:e2-sd-sd-plot}
\end{figure}

\DIFaddend Our hypotheses were fully supported in this experiment. Participants'
...
[\ldiffentity{\textit{Varshney and Sun}, \ldiffentity{2013}}; \ldiffentity{\textit{Fechner}, \ldiffentity{1948}}] means that there is little
...
0.09, \emph{p} = .769). \DIFaddbegin \DIFadd{Our effects sizes were again small in this
...
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=0.5\linewidth]{prediction_ellipse} %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.5\linewidth]{prediction-ellipse-1} \DIFaddendFL \hfill{}
...
[\ldiffentity{\textit{Rensink and Baldridge}, \ldiffentity{2010}}; \textit{Rensink}, \ldiffentity{2012}, \ldiffentity{2014}, \ldiffentity{2017}; \ldiffentity{\textit{Pollack}, \ldiffentity{1960}}],
we found that participants were more accurate and more precise when the
\emph{r} value was higher. \DIFdelbegin \DIFdel{Figure \ref{e2-dist-plots} plots the
objective }\DIFdelend \DIFaddbegin \DIFadd{Figures \ref{e1-changes-plot} and
\ref{e2-changes-plot} plot objective Pearson's }\DIFaddend \emph{r} \DIFdelbegin \DIFdel{value }\DIFdelend against the mean
\DIFdelbegin \DIFdel{correlation estimate and
standard deviation of estimates for the non-linear contrast decay
condition in experiment }\DIFdelend \DIFaddbegin \DIFadd{errors in correlation estimates for experiments 1 and }\DIFaddend 2 \DIFdelbegin \DIFdel{, and }\DIFdelend \DIFaddbegin \DIFadd{respectively.
Standard deviations of estimates are shown as error bars.These plots
}\DIFaddend illustrate, as in many studies cited, the \DIFdelbegin \DIFdel{markedly }\DIFdelend lower levels of precision and
accuracy for \emph{r} values further from 0 or 1.

\begin{figure}
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=0.5\linewidth]{e2-dist-plots-1} \includegraphics[width=0.5\linewidth]{e2-dist-plots-2} %%%
\DIFdelendFL \DIFaddbeginFL 

{\centering \includegraphics{changes-with-r-e1-1} 

}

\DIFaddendFL \caption{\DIFdelbeginFL %DIFDELCMD < \label{e2-dist-plots}%%%
\DIFdelFL{Plotting objective }\textit{\DIFdelFL{r}} %DIFAUXCMD
\DIFdelFL{values against }\DIFdelendFL \DIFaddbeginFL \label{e1-changes-plot}\DIFaddFL{Plots showing how participants' }\DIFaddendFL mean \DIFdelbeginFL \DIFdelFL{error in }\DIFdelendFL correlation \DIFdelbeginFL \DIFdelFL{estimates (}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{estimation errors change with Pearson's }\textit{\DIFaddFL{r}} \DIFaddFL{in experiment 1. Participants were }\DIFaddendFL on \DIFaddbeginFL \DIFaddFL{average most accurate at estimating }\DIFaddendFL the \DIFdelbeginFL \DIFdelFL{left}\DIFdelendFL \DIFaddbeginFL \textit{\DIFaddFL{r}} \DIFaddFL{value when presented with the full contrast scatterplots (condition D}\DIFaddendFL )\DIFdelbeginFL \DIFdelFL{and }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{. Error bars show }\DIFaddendFL standard deviations of \DIFdelbeginFL \DIFdelFL{correlation }\DIFdelendFL estimates\DIFdelbeginFL \DIFdelFL{(on the right) shows that accuracy and precision increase with }\textit{\DIFdelFL{r}}%DIFAUXCMD
\DIFdelendFL .}\DIFdelbeginFL %DIFDELCMD < \label{fig:e2-dist-plots}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \label{fig:changes-with-r-e1}
\DIFaddendFL \end{figure}

\DIFaddbegin \begin{figure}

{\centering \includegraphics{changes-with-r-e2-1} 

}

\caption{\label{e2-changes-plot}\DIFaddFL{Plots showing how participants' mean correlation estimation errors change with Pearson's }\textit{\DIFaddFL{r}} \DIFaddFL{in experiment 2. Participants were on average most accurate at estimating the }\textit{\DIFaddFL{r}} \DIFaddFL{value when presented with the non-linear contrast decay scatterplots (condition A). Error bars show standard deviations of estimates.}}\label{fig:changes-with-r-e2}
\end{figure}
...
\ldiffentity{\textit{Meyer et~al.} [\ldiffentity{1997}]}; \ldiffentity{\textit{Yang et~al.} [\ldiffentity{2019}]}; \ldiffentity{\textit{Rensink} [\ldiffentity{2017}]}}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citealp{cleveland_1982}}\hskip0pt%DIFAUXCMD
;
\mbox{%DIFAUXCMD
\citealp{meyer_1997}}\hskip0pt%DIFAUXCMD
; \mbox{%DIFAUXCMD
\citealp{yang_2019}}\hskip0pt%DIFAUXCMD
; \mbox{%DIFAUXCMD
\citealp{rensink_2017}}\hskip0pt%DIFAUXCMD
}\DIFaddend ). We
...
\DIFadd{Both experiments described in the current work tested lay participants
...
experiment 1 (\(\chi^2\)(1) = 7.13, }\emph{\DIFadd{p}} \DIFadd{= 0.01), but not experiment
2 (\(\chi^2\)(1) = 2.20, }\emph{\DIFadd{p}} \DIFadd{= 0.14). In experiment 1,
...
\DIFadd{Future work might examine correlation estimation when no training is
...
}[\DIFadd{\ldiffentity{\textit{Rensink}, \ldiffentity{2014}}}]\DIFadd{, we would expect only a small effect of training,
...
\DIFadd{Pearson's }\emph{\DIFadd{r}} \DIFadd{can only take a value between 0 and
...
were more accurate and less variable when }\emph{\DIFadd{r}} \DIFadd{was closer to 0 and
...
result of scatterplots tending towards certain patterns when }\emph{\DIFadd{r}} \DIFadd{is
...
\DIFaddend \hypertarget{limitations}{%
...
difficulties. As can be seen in \DIFdelbegin \DIFdel{tables \ref{sum-stats-e1} and
\ref{sum-stats-e2}}\DIFdelend \DIFaddbegin \DIFadd{Figures \ref{e1-dot-plot} and
\ref{e2-dot-plot}}\DIFaddend , and as more specifically illustrated in \DIFdelbegin \DIFdel{Figure
\ref{e2-dist-plots}}\DIFdelend \DIFaddbegin \DIFadd{Figures
\ref{e1-changes-plot} and \ref{e2-changes-plot}}\DIFaddend , participants' estimates
...
judgements made \DIFdelbegin \DIFdel{in isolation}\DIFdelend \DIFaddbegin \DIFadd{on single plots}\DIFaddend .

\DIFdelbegin %DIFDELCMD < \hypertarget{future-work}{%
%DIFDELCMD < \section{Future Work}\label{future-work}}
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{Although we have presented a novel visualization technique that has
resulted in participants' estimates of }\DIFdelend \DIFaddbegin \DIFadd{We have made an important first step in the utilization of contrast
changes to optimize perception of }\DIFaddend correlation in scatterplots\DIFdelbegin \DIFdel{being
...
present}\DIFdelend \DIFaddbegin \DIFadd{, however
...
example}\DIFaddend . It may \DIFaddbegin \DIFadd{well }\DIFaddend be the case that \DIFaddbegin \DIFadd{changing }\DIFaddend the value of \(b\) \DIFdelbegin \DIFdel{we have used in equation }\DIFdelend \DIFaddbegin \DIFadd{as a
function of the objective Pearson's }\emph{\DIFadd{r}} \DIFadd{value could produce more
accurate correlation estimates in participants; our finding that
participants were more accurate in correlation estimation when }\emph{\DIFadd{r}}
\DIFadd{was nearer 0 or }\DIFaddend 1 \DIFdelbegin \DIFdel{is not optimised.
Conducting further research using a variety
of \(b\) values for equation }\DIFdelend \DIFaddbegin \DIFadd{would suggest that the use of a decay parameter for
these correlations is unnecessary.
}

\DIFadd{The simplicity of the direct estimation task we have used does confer
...
different in experiment }\DIFaddend 1 \DIFdelbegin \DIFdel{would be trivial following the framework
we have established in this paper. }\DIFdelend \DIFaddbegin \DIFadd{(0.149) vs experiment 2 (0.123). We suggest
...
\DIFaddbegin \hypertarget{future-work}{%
\section{Future Work}\label{future-work}}

\DIFaddend In this paper we worked strictly with positive \emph{r} values,
primarily because that is what has been investigated in the majority of
the research that informed ours. \DIFdelbegin \DIFdel{Given, however, }\DIFdelend \DIFaddbegin \DIFadd{However, given }\DIFaddend previous work
[\ldiffentity{\textit{Sher et~al.}, \ldiffentity{2017}}] \DIFdelbegin \DIFdel{which }\DIFdelend \DIFaddbegin \DIFadd{that }\DIFaddend found evidence for people overestimating negative
correlation values, it would be reasonable to expect that the technique
we have developed here could also be used to address this bias\DIFdelbegin \DIFdel{also}\DIFdelend . We
...
\DIFdelbegin \DIFdel{Again,
testing this would be trivial
using our framework}\DIFdelend \DIFaddbegin 

\DIFadd{Our manipulations have used only the vertical distance between a
particular point and the regression line to set contrast. Previous work,
some of which has been inconclusive }[\DIFadd{\ldiffentity{\textit{Meyer et~al.}, \ldiffentity{1997}}}]\DIFadd{, has generally
...
}[\DIFadd{\ldiffentity{\textit{Cleveland et~al.}, \ldiffentity{1982}}; \ldiffentity{\textit{Yang et~al.}, \ldiffentity{2019}}; \ldiffentity{\textit{Rensink}, \ldiffentity{2017}}}]\DIFadd{. Future work
...
manipulation}\DIFaddend .

\DIFaddbegin \DIFadd{In addition to the range of scatterplot-associated tasks mentioned in
...
}\emph{\DIFadd{r}} \DIFadd{unsuitable for the numerical representation of non-linear
correlation, and a number of other measurements have been proposed
}[\DIFadd{\ldiffentity{\textit{Laarne et~al.}, \ldiffentity{2021}}}]\DIFadd{. The techniques we have used in the current paper
could be extended for use with non-linear correlations in the future.
}

\DIFadd{The final and perhaps most exciting avenue for future work is the
...
\ldiffentity{\textit{Liu et~al.} [\ldiffentity{2021}]} used triangular scatterplot points of different
...
\DIFadd{This work was supported by funding from the University of Manchester
Department of Computer Science.
}

\DIFaddend \renewcommand\refname{References}
\bibliography{contrast-scatterplots.bib}


\DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\nocite{azzam_2013,friendly_2005,bbc_2022,tufte_1983,kay_heer_2015,rensink_2014,pollack_1960,strahan_1978,bobko_1979,cleveland_1982,lane_1985,lauer_1989,collyer_1990,meyer_1992,rensink_2010,rensink_2017,meyer_1997,yang_2019,matejka_2015,bertini_2004,rensink_2012,wehrhahn_1990,champion_2017,hong_2021,healey_2012,hadley_gg2016,stone_2008,zuffi_2007,pierce_psychopy_2019,garcia_2016,voeten_buildmer_2022,peer_2021,r_core,bates_lme4_2015,barr_random_2013,emmeans,varshney_2013,fechner_1948,netzel_2017,sher_2017}
 }\hskip0pt%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\nocite{azzam_2013,friendly_2005,tufte_1983,kay_heer_2015,rensink_2014,behrisch_2021,pollack_1960,strahan_1978,bobko_1979,cleveland_1982,lane_1985,lauer_1989,collyer_1990,meyer_1992,micallef_2017,rensink_2010,rensink_2017,meyer_1997,yang_2019,matejka_2015,bertini_2004,ginsburg_2003,rensink_2012,wehrhahn_1990,champion_2017,hong_2021,healey_2012,hadley_gg2016,stone_2008,zuffi_2007,pierce_psychopy_2019,garcia_2016,voeten_buildmer_2022,ghasemi_2012,peer_2021,varshney_2013,fechner_1948,netzel_2017,sher_2017,laarne_2021,liu_2021}
 }\hskip0pt%DIFAUXCMD
