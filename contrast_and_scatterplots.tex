...
size or contrast, although this was carried out uniformly to do deal
with overplotting issues.In addition to studies employing discriminative
...
Decreasing the size of the point cloud here also had the effect of
narrowing the width of the distribution displayed, as the length of the
minor axis decreased.
...
with higher correlation will generally have lower distances between
their points and the regression line.
...
\citep{bates_lme4_2015}) packages, with contrast condition being set as
the predictor for participants' error in correlation estimates.
...
investigating a mathematical relationship between correlation and
...
study's heightened experimental power represents strong evidence that
total contrast in a scatterplot can affect people's perceptions of
...
\citep{voeten_buildmer_2022}) and \textbf{lme4} (version 1.1-30
\citep{bates_lme4_2015}) packages, with contrast decay function being
...
close to one (scatterplot tends towards a single line of points) and 0
...
Perhaps the most interesting avenue for future work is the possibility
of combining the technique we have used here with other novel
scatterplot techniques that have a basis in the literature.
